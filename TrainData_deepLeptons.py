...
class TrainData_deepLeptons_Electrons(TrainData_fullTruth):
    ...
    def __init__(self):
        ...
        self.addBranches([
        'lep_pt', 'lep_eta', 'lep_rho', 'lep_innerTrackChi2', 'lep_globalTrackChi2', 'lep_glbTrackProbability',
        'lep_etaSc', 'lep_sigmaIEtaIEta', 'lep_full5x5_sigmaIetaIeta', 'lep_dEtaInSeed', 'lep_dPhiScTrkIn', 'lep_dEtaScTrkIn', 'lep_eInvMinusPInv', 'lep_convVeto_float', 'lep_hadronicOverEm',
        #'lep_segmentCompatibility', 'lep_muonInnerTrkRelErr', 'lep_isGlobalMuon_float', 'lep_chi2LocalPosition', 'lep_chi2LocalMomentum',
        'lep_relIso03', 'lep_relIso04', 'lep_miniRelIso', 'lep_puppiWeight', 'lep_hcalFraction', 'lep_lostHits_float', 'lep_innerTrackValidHitFraction',
        'lep_jetDR', 'lep_dxy', 'lep_dz', 'lep_edxy', 'lep_edz', 'lep_ip3d', 'lep_sip3d', 'lep_dxy_pf', 'lep_dz_pf', 'lep_dzAssociatedPV', 'lep_EffectiveArea03', 
        'lep_jetPtRatiov1', 'lep_jetPtRelv1', 'lep_jetPtRatiov2', 'lep_jetPtRelv2', 'lep_ptErrTk', 
        'lep_npfCands_neutral_float', 'lep_npfCands_charged_float', 'lep_npfCands_photon_float', 'lep_npfCands_electron_float', 'lep_npfCands_muon_float'
        ])

        self.addBranches(['pfCand_neutral_pt', 'pfCand_neutral_eta', 'pfCand_neutral_phi', 'pfCand_neutral_mass', 'pfCand_neutral_puppiWeight', 'pfCand_neutral_hcalFraction', 'pfCand_neutral_fromPV'],25)
        self.addBranches(['pfCand_charged_pt', 'pfCand_charged_eta', 'pfCand_charged_phi', 'pfCand_charged_mass', 'pfCand_charged_puppiWeight', 'pfCand_charged_hcalFraction', 'pfCand_charged_fromPV'],50)
        self.addBranches(['pfCand_photon_pt', 'pfCand_photon_eta', 'pfCand_photon_phi', 'pfCand_photon_mass', 'pfCand_photon_puppiWeight', 'pfCand_photon_hcalFraction', 'pfCand_photon_fromPV'],25)
        self.addBranches(['pfCand_electron_pt', 'pfCand_electron_eta', 'pfCand_electron_phi', 'pfCand_electron_mass'],25)
        self.addBranches(['pfCand_muon_pt', 'pfCand_muon_eta', 'pfCand_muon_phi', 'pfCand_muon_mass'],25)
        self.addBranches(['SV_pt', 'SV_eta', 'SV_phi', 'SV_mass', 'SV_chi2', 'SV_ndof', 'SV_dxy', 'SV_edxy', 'SV_ip3d', 'SV_eip3d', 'SV_sip3d', 'SV_cosTheta', 'SV_deltaR', 
