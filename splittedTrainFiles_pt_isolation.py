...
readPath = '/afs/hephy.at/work/g/gmoertl/CMSSW_9_4_6_patch1/src/DeepLepton/preprocessing/classsamples_pt_isolation/'
readFileSuffix = '_medium.root'
writePath = '/afs/hephy.at/work/g/gmoertl/CMSSW_9_4_6_patch1/src/DeepLepton/preprocessing/trainsamples_pt_isolation_a90k/'
...
for pt_cut in pt_cuts:
    ...
    for lep in lep_files:
        ...
        n_actualentries=0
        n_file=1
        fileprefix = (writePath+'trainfile_iso_medium_ele'+ptSuffix+'_' if lep==ele_files else writePath+'trainfile_iso_medium_muo'+ptSuffix+'_')    
