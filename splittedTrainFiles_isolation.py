...
ele_par = [
            {"filename": 'classsamples_isolation/elePrompt_tight.root',"lep_pdgId": 11, "lep_isClassId": 'lep_isPromptId'},
            {"filename": 'classsamples_isolation/eleNonPrompt_tight.root',"lep_pdgId": 11, "lep_isClassId": 'lep_isNonPromptId'},
            {"filename": 'classsamples_isolation/eleFake_tight.root',"lep_pdgId": 11, "lep_isClassId": 'lep_isFakeId'},
          ]

muo_par = [
            {"filename": 'classsamples_isolation/muoPrompt_tight.root',"lep_pdgId": 13, "lep_isClassId": 'lep_isPromptId'},
            {"filename": 'classsamples_isolation/muoNonPrompt_tight.root',"lep_pdgId": 13, "lep_isClassId": 'lep_isNonPromptId'},
            {"filename": 'classsamples_isolation/muoFake_tight.root',"lep_pdgId": 13, "lep_isClassId": 'lep_isFakeId'},
          ]
...
ch = ROOT.TChain('tree')
ch.Add('classsamples_isolation/muoFake_tight.root')
...
for lep in lep_files:
    ...
    n_actualentries=0
    n_file=1
    fileprefix = ("trainsamples_isolation/trainfile_iso_ele_" if lep==ele_files else "trainsamples_isolation/trainfile_iso_muo_")    
